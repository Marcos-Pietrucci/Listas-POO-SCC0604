...
public class Server implements Runnable{
    ...
    public void waitingAuth(ClientHandler client)
    {
        System.out.println("->Aguardando autenticação de " + client.getName());
        sender.send("Aguardando autenticação...",client);
    }
    
    public void accept(ClientHandler client)
    {
        System.out.println("->Conexão do " + client.getName() + " autenticada");
        sender.send("Conexão autenticada!",client);
        sender.send("Bem vindo " + client.getName(),client);
        client.setAuth(true);
    }
    
    public void refuse(ClientHandler client)
    {
        System.out.println("->Conexão do " + client.getName() + " recusada!");
        sender.send("Conexão recusada!",client);
    }
